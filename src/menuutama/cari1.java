...
public class cari1 extends javax.swing.JFrame {
    ...
    private void btnpilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpilihActionPerformed
        ...
        Pesanan.txkodebarang.setText(id);
        Pesanan.txnama1.setText(nama);
        Pesanan.txharga.setText(harga);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cari1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
